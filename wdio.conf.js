...
exports.config = {
    ...
    onPrepare: function (config, capabilities) {
        ...
        fsExtra.emptyDirSync('allure-report')
        fsExtra.emptyDirSync('reports/screenshots')
    ...
    afterStep: function (step, context, { error, result, duration, passed, retries }) {
        if (error) {
            browser.saveScreenshot('./reports/screenshots/' + step.text + '.png')
        }
    },
    /**
     *
